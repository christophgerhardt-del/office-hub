...
# Danach läuft die App bei jeder Anmeldung automatisch unter http://<Name-des-Macs>.local:8741
...
exec /usr/bin/python3 -m http.server 8741 --bind 0.0.0.0
EOF
...
sleep 1
if curl -s -o /dev/null "http://127.0.0.1:8741/index.html"; then
  echo ""
  echo "✅ OfficeHub läuft lokal:"
  echo "   http://$NAME.local:8741   oder   http://$IP:8741"
